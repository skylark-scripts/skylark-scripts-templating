define([
  ...
  '../utils', 
  './AST',
], function (Evented,templater,_Exception, _utils, _AST) {
  ...
  var Compiler = Evented.inherit({
    ...
    accept: function accept(node) {
      ...
      if (!this[node.type]) {
        throw new _Exception('Unknown type: ' + node.type, node);
      }
  ...
  function transformLiteralToPath(sexpr) {
   ...
   return templater.compiler.Compiler = Compiler;
});